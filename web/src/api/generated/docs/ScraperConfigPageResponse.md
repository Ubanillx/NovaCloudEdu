...
------------ | ------------- | ------------- | -------------
**records** | [**Array&lt;ScraperConfigResponse&gt;**](ScraperConfigResponse.md) | 配置列表 | [optional] [default to undefined]
...
```typescript
import { ScraperConfigPageResponse } from './api';

const instance: ScraperConfigPageResponse = {
    records,
    total,
    pageNum,
    pageSize,
