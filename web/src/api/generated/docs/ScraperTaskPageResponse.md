...
------------ | ------------- | ------------- | -------------
**records** | [**Array&lt;ScraperTaskResponse&gt;**](ScraperTaskResponse.md) | 任务列表 | [optional] [default to undefined]
...
```typescript
import { ScraperTaskPageResponse } from './api';

const instance: ScraperTaskPageResponse = {
    records,
    total,
    pageNum,
    pageSize,
