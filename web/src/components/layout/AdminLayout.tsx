...
const AdminSider: React.FC<AdminSiderProps> = ({ 
  ...
  const allMenuItems = [
    ...
    { icon: Library, label: '电子书管理', path: '/admin/ebooks' },
    ...
    { icon: BookA, label: '每日单词管理', path: '/admin/daily-words' },
    { icon: FileText, label: '每日美文管理', path: '/admin/daily-articles' },
    { icon: Crown, label: '会员管理', path: '/admin/membership' },
    { icon: ShoppingCart, label: '订单管理', path: '/admin/orders' },
    { icon: Plug2, label: 'MCP 服务器管理', path: '/admin/mcp-servers' },
