...
const FloatingProgressBar: React.FC<FloatingProgressBarProps> = ({ currentIndex, totalChapters, themeVars, onGoChapter }) => {
  return (
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 animate-in fade-in duration-300">
      <div
        className="flex items-center gap-4 px-4 py-2 rounded-2xl shadow-xl border ring-1 ring-black/5 dark:ring-white/10 transition-all"
        style={{
