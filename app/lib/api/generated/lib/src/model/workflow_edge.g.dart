...
class _$WorkflowEdge extends WorkflowEdge {
  @override
  final String? id;
  @override
  ...
  factory _$WorkflowEdge([void Function(WorkflowEdgeBuilder)? updates]) =>
      (WorkflowEdgeBuilder()..update(updates))._build();
  ...
  @override
  WorkflowEdge rebuild(void Function(WorkflowEdgeBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  WorkflowEdgeBuilder toBuilder() => WorkflowEdgeBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WorkflowEdge')
          ..add('id', id)
...
class WorkflowEdgeBuilder
    implements Builder<WorkflowEdge, WorkflowEdgeBuilder> {
  _$WorkflowEdge? _$v;
  ...
  WorkflowEdgeBuilder() {
    WorkflowEdge._defaults(this);
  }

  WorkflowEdgeBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(WorkflowEdge other) {
    _$v = other as _$WorkflowEdge;
  }

  @override
  void update(void Function(WorkflowEdgeBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  WorkflowEdge build() => _build();

  _$WorkflowEdge _build() {
    final _$result =
        _$v ??
        _$WorkflowEdge._(
          id: id,
