...
part 'scraper_config_response.g.dart';
...
/// * [updateTime]
@BuiltValue()
abstract class ScraperConfigResponse
    implements Built<ScraperConfigResponse, ScraperConfigResponseBuilder> {
  ...
  ScraperConfigResponse._();

  factory ScraperConfigResponse(
      [void updates(ScraperConfigResponseBuilder b)]) = _$ScraperConfigResponse;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ScraperConfigResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ScraperConfigResponse> get serializer =>
      _$ScraperConfigResponseSerializer();
}

class _$ScraperConfigResponseSerializer
    implements PrimitiveSerializer<ScraperConfigResponse> {
  @override
  final Iterable<Type> types = const [
    ScraperConfigResponse,
    _$ScraperConfigResponse
  ];

  @override
  final String wireName = r'ScraperConfigResponse';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ScraperConfigResponse object, {
  ...
  void _deserializeProperties(
    ...
    required ScraperConfigResponseBuilder result,
  ...
  @override
  ScraperConfigResponse deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ScraperConfigResponseBuilder();
