...
part 'update_schedule_setting_request.g.dart';
...
/// * [timeConfig]
@BuiltValue()
abstract class UpdateScheduleSettingRequest
    implements
        Built<UpdateScheduleSettingRequest,
  ...
  UpdateScheduleSettingRequest._();

  factory UpdateScheduleSettingRequest(
          [void updates(UpdateScheduleSettingRequestBuilder b)]) =
      _$UpdateScheduleSettingRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateScheduleSettingRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateScheduleSettingRequest> get serializer =>
      _$UpdateScheduleSettingRequestSerializer();
}

class _$UpdateScheduleSettingRequestSerializer
    implements PrimitiveSerializer<UpdateScheduleSettingRequest> {
  @override
  ...
  @override
  final String wireName = r'UpdateScheduleSettingRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateScheduleSettingRequest object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateScheduleSettingRequestBuilder result,
  ...
  @override
  UpdateScheduleSettingRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateScheduleSettingRequestBuilder();
