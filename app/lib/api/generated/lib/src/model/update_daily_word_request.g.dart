...
part of 'update_daily_word_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$UpdateDailyWordRequest extends UpdateDailyWordRequest {
  @override
  final String word;
  @override
  ...
  factory _$UpdateDailyWordRequest([
    void Function(UpdateDailyWordRequestBuilder)? updates,
  ]) => (UpdateDailyWordRequestBuilder()..update(updates))._build();

  _$UpdateDailyWordRequest._({
    required this.word,
  ...
  @override
  UpdateDailyWordRequest rebuild(
    void Function(UpdateDailyWordRequestBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  UpdateDailyWordRequestBuilder toBuilder() =>
      UpdateDailyWordRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UpdateDailyWordRequest &&
        word == other.word &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UpdateDailyWordRequest')
          ..add('word', word)
...
class UpdateDailyWordRequestBuilder
    implements Builder<UpdateDailyWordRequest, UpdateDailyWordRequestBuilder> {
  _$UpdateDailyWordRequest? _$v;
  ...
  UpdateDailyWordRequestBuilder() {
    UpdateDailyWordRequest._defaults(this);
  }

  UpdateDailyWordRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _word = $v.word;
  ...
  @override
  void replace(UpdateDailyWordRequest other) {
    _$v = other as _$UpdateDailyWordRequest;
  }

  @override
  void update(void Function(UpdateDailyWordRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UpdateDailyWordRequest build() => _build();

  _$UpdateDailyWordRequest _build() {
    final _$result =
        _$v ??
        _$UpdateDailyWordRequest._(
