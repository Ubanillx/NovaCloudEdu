...
// tests for CreateDailyArticleRequest
void main() {
  final instance = CreateDailyArticleRequestBuilder();
  // TODO add properties to the builder and call build()

  group(CreateDailyArticleRequest, () {
    // 文章标题
    // String title
    ...
    // 预计阅读时间(分钟)
    // int readTime
    test('to test the property `readTime`', () async {
      // TODO
    });
  });
}
