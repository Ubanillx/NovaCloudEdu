...
// tests for DailyWordResponse
void main() {
  final instance = DailyWordResponseBuilder();
  // TODO add properties to the builder and call build()

  group(DailyWordResponse, () {
    // ID
    // int id
    ...
    test('to test the property `pronunciation`', () async {
      // TODO
    });
    ...
    test('to test the property `exampleTranslation`', () async {
      // TODO
    });
    ...
    test('to test the property `difficultyDesc`', () async {
      // TODO
    });
