...
class _PostDetailPageState extends State<PostDetailPage> {
  ...
  Widget _buildPostContent() {
    final colors = context.colors;
    final postTypeLabel = getPostTypeLabel(_post?.postType);
    return Container(
          ...
          Row(
            children: [
              GestureDetector(
                ...
                child:
                    _authorInfo?.userAvatar != null &&
                        _authorInfo!.userAvatar!.isNotEmpty
                    ? CircleAvatar(
                        radius: 20,
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child:
                userInfo?.userAvatar != null && userInfo!.userAvatar!.isNotEmpty
                ? CircleAvatar(
                    radius: 40,
          ...
          if (userInfo?.userProfile != null &&
              userInfo!.userProfile!.isNotEmpty) ...[
            const SizedBox(height: 12),
            Padding(
